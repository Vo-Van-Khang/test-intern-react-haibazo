        ...
        <div className='board'>
            <div className="control">
                ...
                <div>
                    ...
                    <input type="number" id='points' value={point} onChange={(e) => setPoint(e.target.value)}/>
                </div>
                <div>
                ...
                <div className='btns'>
                    <button onClick={handleClick}>{!isPlay ? "Play" : "Restart"}</button>
            ...
            <div className="display">
                {elements.map((e, i) => (
                    <Element key={i} index={i} number={e.number} top={e.top} left={e.left} handleRemove={handleRemove} isHint={e.isHint}/>
                ))}
            </div>
        </div>
    );
